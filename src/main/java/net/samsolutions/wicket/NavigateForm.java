...
import net.samsolutions.wicket.models.FileModelForNavigate;
...
public class NavigateForm<T> extends Form<T> {
     ...
     * @param path
     * @param albumId
     * @param fileId  current displayed file id
     * @param cls class of page image on
     */
	public NavigateForm(String path, int albumId, int fileId, final Class<? extends IRequestablePage> cls) {
		super(path);
